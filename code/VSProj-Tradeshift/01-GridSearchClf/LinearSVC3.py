...
if __name__ == '__main__':
    ...
    df_output_dec_func = pd.DataFrame(df_test[['id']])
    df_train_dec_func = pd.DataFrame(df_train_Y[['id']])
    ...
    for colName in yCols[1:]:
        ...
        if np.any(Y_train != 0):
            ...
            df_train_dec_func[colName] = clf.decision_function(X_train)
