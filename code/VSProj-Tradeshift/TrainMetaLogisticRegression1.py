...
if __name__ == '__main__':
    ...
    df_train_X2 = pd.read_csv(clfFolder_base1 + "output_base.csv")
	...
	for colName in yCols[1:]:
        ...
        if np.any(Y_train != 0):
			...
			X_train = np.hstack((df_train_X1[colName].values, df_train_X2[colName].values))
